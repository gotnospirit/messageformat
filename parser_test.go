...
func doTestPassthru(t *testing.T, input string) {
	doTest(t, Test{
		input,
		[]Expectation{
			{output: input},
...
func TestPassthru(t *testing.T) {
	...
	doTestPassthru(t, `\\\`)
	doTestPassthru(t, `\q\`)
	doTestPassthru(t, `test\`)
	doTestPassthru(t, "\n")
	doTestPassthru(t, `\n`)
	doTestPassthru(t, " This is \n a string\"")
	doTestPassthru(t, "日本語")
	doTestPassthru(t, "Hello, 世界")
}

func BenchmarkPassthru(b *testing.B) {
...
func TestSelectOrdinal(t *testing.T) {
	doTest(t, Test{
		...
		[]Expectation{
			...
			{map[string]interface{}{"FLOOR": 1}, "The 1st floor."},
			{map[string]interface{}{"FLOOR": 2}, "The 2nd floor."},
			{map[string]interface{}{"FLOOR": 3}, "The 3rd floor."},
